...
class UserControllerTest {
    ...
    void signUp_O() throws Exception{
        ...
        SignupResponseDTO expectedResponse = new SignupResponseDTO("true",201);
    ...
    void signUp_X_1() throws Exception{
        ...
        SignupResponseDTO expectedResponse = new SignupResponseDTO("false",409);
    ...
    void signUp_X_2() throws Exception{
        ...
        SignupResponseDTO expectedResponse = new SignupResponseDTO("false",400);
        String request = objectMapper.writeValueAsString(userRequestDTO);
